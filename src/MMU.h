...
class MMU{
    public:
        ...
        MMU():
            inBios(true), workingRAM({0}), externalRAM({0}), zeroPageRAM({0}),
            bios({
    ...
    private:
        bool inBios;
        unsigned char *ROM; //rom file mapped to memory
        ...
        std::array<unsigned char, 256> bios; //holds the bios program
};
